...
from .image_processing import load_and_process_image, save_processed_image, filter_detections
...
def segment_and_visualize(image_path: str) -> SegmentationResult:
    ...
    segmentation_results = florence2_sam2_image("stacker reclaimer, iron ore piles", image)
...
def segment_conveyor_belts(image_path: str) -> str:
    ...
    highlighted_image = overlay_segmentation_masks(image, filtered_segmentations, draw_label=True)
